				...
				<c:forEach items="${goods}" var="good">
					<tr>
						...
						<td class="col-md-2">
							...
							<a href="/removeFromBucket/${good.id}" class="btn btn-danger pull-right delete">Delete</a> 
							<a href="/buy/${good.id}" class="btn btn-success pull-right delete">Buy</a>
							<a href="/showGoods/${good.id}" class="btn btn-primary pull-right view">View</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
